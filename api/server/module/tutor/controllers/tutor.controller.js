...
exports.changeStatus = async (req, res, next) => {
  try {
    ...
    if (req.tutor.isActive) {
      await Service.Mailer.send('admin-active-tutor', req.tutor.email, {
        subject: 'Admin activated your profile',
        tutor: req.tutor.toObject(),
        appName: process.env.APP_NAME,
        adminEmail: process.env.ADMIN_EMAIL
      });
    } else {
      await Service.Mailer.send('admin-inactive-tutor', req.tutor.email, {
